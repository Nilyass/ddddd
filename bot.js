...
client.on('message', message => {
   ...
   if(message.content.split(' ')[0] == 'G.color'){
     ...
     .setFooter('by proffesor akali '+message.author.username, message.author.avatarURL)
...
if (message.author.id !== '414555439536275459') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult);
